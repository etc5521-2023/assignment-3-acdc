...
```{r trend, warning = FALSE, message = FALSE , echo=FALSE}
...
- The right graph in (@fig-plots14) depicts the average temperature trends 
...
According to the (@fig-plots15) above, it's evident that all the graphs 

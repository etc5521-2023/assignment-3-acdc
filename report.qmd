...
weeping_mulla_mulla <- weeping_mulla_mulla %>%
                          mutate(Quarter = paste("Q", lubridate::quarter(eventDate), sep = ""), #extract quarter using lubridate package
                                 Year_Quarter = tsibble::yearquarter(eventDate)) #extract quarter using tsibble package for join purpose
```
